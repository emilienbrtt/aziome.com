  ...
  return (
    <section className="relative pt-32 md:pt-40 pb-16 md:pb-24 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative">
        ...
        >
          Aziome déploie des agents qui automatisent votre quotidien en vous faisant gagner du temps sur les tâches répétitives. Ils sont disponibles 24/24h et 7/7j. 
        </motion.p>
