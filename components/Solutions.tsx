...
export default function Solutions() {
  ...
  // Layout fixe (12 colonnes)
  // Row 1: Max (1-4) | Léa (5-8) | Jules (9-12)
  // Row 2: Mia (3-6) | Chris (7-10) -> bien centrées
  const miniCards = [
    {
      key: 'crm' as const,
      title: 'Max',
      bullets: [
        'Assure le suivi de vos clients et leur envoie des rappels personnalisés pour ne rien oublier.',
      ],
      Icon: Repeat,
    ...
    },
    {
      ...
      title: 'Mia',
      bullets: [
        'Premier contact de votre entreprise, elle accueille chaque demande et oriente vers la bonne personne.',
      ],
      Icon: MessageCircle,
  ...
  // Toujours 5 emplacements : si une carte est ouverte, on rend un placeholder invisible à sa place
    ...
    <section id="solutions" className="max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-12">
        {cardsWithPlaceholder.map(({ key, title, bullets, Icon, layout, isPlaceholder }) => (
          ...
          >
            {isPlaceholder ? (
              // Placeholder invisible pour garder la géométrie exacte
              ...
              <Card>
                <div className="flex items-start gap-3 h-full min-h-[200px] group transition-[transform,box-shadow] duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_30px_rgba(212,175,55,0.15)]">
    ...
    <Card>
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="mt-3 text-muted">
            <strong>Ce que l’agent fait :</strong> met vos chiffres sur une page simple, envoie une alerte s’il détecte un problème et répond à « Combien avons-nous vendu hier ? ».
          </p>
          <div className="mt-4 grid md:grid-cols-3 gap-6 text-sm">
            <div>
              <h4 className="font-medium">Pourquoi c’est utile</h4>
    ...
    <Card>
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="mt-3 text-muted">
            <strong>Ce que l’agent fait :</strong> accueille chaque demande, pose les bonnes questions et oriente vers la bonne personne ou le bon service.
          </p>
          <div className="mt-4 grid md:grid-cols-3 gap-6 text-sm">
            <div>
              <h4 className="font-medium">Pourquoi c’est utile</h4>
    ...
    <Card>
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="mt-3 text-muted">
            <strong>Ce que l’agent fait :</strong> gère les demandes internes (attestations, absences, congés), prépare les documents et répond aux questions courantes des équipes.
          </p>
          <div className="mt-4 grid md:grid-cols-3 gap-6 text-sm">
            <div>
              <h4 className="font-medium">Pourquoi c’est utile</h4>
