        ...
        <Card>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <a href="#sav" className="text-sm mt-3 inline-block text-[color:var(--gold-1)]">Voir le détail →</a>
            </div>
          </div>
        </Card>
        <Card>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <a href="#crm" className="text-sm mt-3 inline-block text-[color:var(--gold-1)]">Voir le détail →</a>
            </div>
          </div>
        </Card>
        <Card>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <a href="#reporting" className="text-sm mt-3 inline-block text-[color:var(--gold-1)]">Voir le détail →</a>
            </div>
          </div>
        </Card>
      </div>
