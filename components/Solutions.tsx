          ...
          {CARDS.map((c) => (
            <article
              ...
              className="
                ...
                rounded-2xl bg-[#0b0b0b]
                ring-1 ring-white/12                /* bord fin continu */
                hover:ring-[rgba(212,175,55,0.38)]   /* doré doux au hover */
                hover:shadow-[0_0_120px_rgba(212,175,55,0.20)]
                transition
              "
            >
              {/* Cadre interne : coins masqués, ombres non coupées */}
              <div className="rounded-[inherit] overflow-hidden">
                {/* ==== IMAGE & DÉGRADÉ — ajustés comme ta capture ==== */}
                <div className="relative w-full bg-black">
                  {/* Hauteur fixe responsive pour garder la même taille de cadre */}
                  <div className="h-[360px] sm:h-[420px] lg:h-[460px] relative">
                    <Image
                      ...
                      className="
                        ...
                        /* marge visuelle en haut pour ne pas couper la tête */
                        p-2 sm:p-3
                      "
                    />
                    {/* Dégradé profond vers le texte (≈ 58%) */}
                    <div
